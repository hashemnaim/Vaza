...
import '../../../services/favorite_function_service.dart';
...
class CardProduct extends StatelessWidget {
  CardProduct({super.key, required this.index, required this.productsList});
  final int index;
  final List<ProductlData> productsList;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          CustomNetworkImage(
              imagePath: productsList[index].mainPhoto ?? "",
              height: 119,
              width: 150,
              borderRadius: 12,
